...
<c:set var="mheader" value="${pageContext.request.contextPath}"></c:set>
<header class="main-header">
	<!-- Logo -->
	<a href="index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels --> <span class="logo-mini"><b>M</b>agic</span>
		<!-- logo for regular state and mobile devices --> <span class="logo-lg"><b>Magic</b>Web</span>
	</a>
		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
							...
							<ul class="menu">
								<li>
									<!-- start message --> <a href="#">
										<div class="pull-left">
											<img src="${mheader}/static/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
										</div>
										<h4>
								...
								<li><a href="#">
										<div class="pull-left">
											<img src="${mheader}/static/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
										</div>
										<h4>
								...
								<li><a href="#">
										<div class="pull-left">
											<img src="${mheader}/static/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
										</div>
										<h4>
				...
				<li class="dropdown user user-menu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img
						src="${mheader}/static/dist/img/user2-160x160.jpg" class="user-image" alt="User Image"> <span class="hidden-xs">Alexander
							Pierce</span>
				</a>
					<ul class="dropdown-menu">
						<!-- User image -->
						<li class="user-header"><img src="${mheader}/static/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
